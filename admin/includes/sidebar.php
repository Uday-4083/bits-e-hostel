...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="attendence.php"
        ...
        class="hide-menu">Register a Student</span></a></li>
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="fee.php"
        aria-expanded="false"><i class="fas fa-dollar-sign"></i><span
        class="hide-menu">Students Fee</span></a></li>

        <!--<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="#"
        aria-expanded="false"><i class="fas fa-user-circle"></i><span
        class="hide-menu">Staff Salary</span></a></li>-->
        ...
        class="hide-menu">Parcel Management</span></a></li>

        <!--<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="#"
        aria-expanded="false"><i class="fas fa-book"></i><span
        class="hide-menu">Complains Management</span></a></li>-->
